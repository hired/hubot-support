...
NameView   = require './name_view'
{Message, SystemMessage, UserMessage, SupportMessage} = require './chat_models'
{Primus, BCSocket} = require './primus-client'

Primus.__origRequire = Primus.require
Primus.require = (module) ->
  if module == 'browserchannel'
    {BCSocket: BCSocket}
  else
    @__origRequire module
